...
MIDDLEWARE = [
    ...
    'epaper.middleware.PageImageCacheMiddleware',
...
SITE_BASE_URL = os.getenv("SITE_BASE_URL", "https://pressnexa.live-app.in").rstrip("/")
...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", EMAIL_HOST_USER or "Press Nexa <no-reply@pressnexa.live-app.in>")
...
WHATSAPP_PAYMENT_SUCCESS_TEMPLATE = os.getenv("WHATSAPP_PAYMENT_SUCCESS_TEMPLATE", "pressnexa_payment_success")
WHATSAPP_PAYMENT_FAILED_TEMPLATE = os.getenv("WHATSAPP_PAYMENT_FAILED_TEMPLATE", "pressnexa_payment_failed")
WHATSAPP_PAYMENT_SUCCESS_MESSAGE_ID = os.getenv("WHATSAPP_PAYMENT_SUCCESS_MESSAGE_ID", "")
WHATSAPP_PAYMENT_FAILED_MESSAGE_ID = os.getenv("WHATSAPP_PAYMENT_FAILED_MESSAGE_ID", "")
