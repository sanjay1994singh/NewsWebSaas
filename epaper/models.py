...
class EPaperEdition(UUIDModel, TimeStampedModel):
    ...
    processing_token = models.CharField(max_length=32, blank=True, default='')
    processing_started_at = models.DateTimeField(null=True, blank=True)
    processing_updated_at = models.DateTimeField(null=True, blank=True)
    processing_total = models.PositiveIntegerField(default=0)
    processing_done = models.PositiveIntegerField(default=0)
