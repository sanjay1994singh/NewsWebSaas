...
class CustomerAcquisition(UUIDModel, TimeStampedModel):
    ...
    provider_payment_qr_id = models.CharField(max_length=120, blank=True, db_index=True)
    provider_payment_qr_url = models.URLField(blank=True)
    provider_payment_qr_image_url = models.URLField(blank=True)
    ...
    tax_rate_percent = models.PositiveIntegerField(default=0)
